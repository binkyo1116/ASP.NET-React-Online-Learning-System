					...
					<div className='request-container'>
						<div className='custom-card over-section'>
							<div>
								...
								<p className='text-cus-secondary font-18'>Enter your registered email address. We’ll send you an email with a new autogenerated password</p>
							</div>
							<div className='mb-3'>
								<InputField
									type='email'
						...
						<div className='wide-section py-3'>
							...
							<div className='mb-5'>
								<h3 className='font-24 text-white mb-2'>Got your password ?</h3>
